...
#define IS_DEVA(ch)		(!IS_NPC(ch) && (GET_LEVEL(ch) >= LVL_DEVA))
...
#define TRADE_CLIENT       (1 << 3)
#define TRADE_AGENT        (1 << 4)
...
#define NOTRADE_CLIENT(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_CLIENT))
#define NOTRADE_AGENT(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_AGENT      ))
...
#define NOTRADE_MEDIA(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_JOURNALIST))
...
#define MSG_NO_STEAL_HERE	"$n is a thief!"

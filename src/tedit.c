...
ACMD(do_tedit)
{
  ...
  struct {
	...
	{ "news",	LVL_GRDEVA,	&news,		8192,	NEWS_FILE},
	{ "motd",	LVL_GRDEVA,	&motd,		2400,	MOTD_FILE},
	{ "imotd",	LVL_IMPL,	&imotd,		2400,	IMOTD_FILE},
  { "greetings",  LVL_IMPL,       &GREETINGS,     2400,   GREETINGS_FILE},
  { "help",       LVL_GRDEVA,      &help,          2400,   HELP_PAGE_FILE},
	{ "ihelp",      LVL_GRDEVA,	&ihelp, 	2400,	IHELP_PAGE_FILE},
	{ "info",	LVL_GRDEVA,	&info,		8192,	INFO_FILE},
  ...
  { "immlist",    LVL_GRDEVA,      &immlist,       2400,   IMMLIST_FILE},
	{ "\n",		0,		NULL,		0,	NULL }
  };

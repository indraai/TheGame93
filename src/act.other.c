...
ACMD(do_gen_tog)
{
  ...
  const char *tog_messages[][2] = {
    ...
    {"Autosplit disabled.\r\n",
    "Autosplit enabled.\r\n"},
    {"Autooffering disabled.\r\n",
    "Autooffering enabled.\r\n"},
    {"Autoassist disabled.\r\n",
    "Autoassist enabled.\r\n"},
    {"Automap disabled.\r\n",
    "Automap enabled.\r\n"},
  ...
  case SCMD_AUTOSPLIT:
    ...
    break;
  case SCMD_AUTOOFFER:
    result = PRF_TOG_CHK(ch, PRF_AUTOOFFER);
    break;
...
static void show_happyhour(struct char_data *ch)
{
  ...
  if ((IS_HAPPYHOUR) || (GET_LEVEL(ch) >= LVL_GRDEVA))
  {
      if (HAPPY_TIME)
      ...
      send_to_char(ch, "tbaMUD Happy Hour!\r\n"
                       ...
                       (IS_HAPPYEXP || (GET_LEVEL(ch) >= LVL_DEVA)) ? happyexp : "",
                       (IS_HAPPYGOLD || (GET_LEVEL(ch) >= LVL_DEVA)) ? happygold : "",
                       (IS_HAPPYQP || (GET_LEVEL(ch) >= LVL_DEVA)) ? happyqp : "",

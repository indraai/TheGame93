...
static void cedit_disp_crash_save_options(struct descriptor_data *d)
{
  ...
  write_to_output(d, "\n\r"
    "\n## Config Editor\r"
  	"\ncloudsel[A:Free Rent]:%s\r"
  	"\ncloudsel[B:Max Objects Saved]:%d\r"
  	"\ncloudsel[C:Minimum Rent Cost]:%d\r"
  	"\ncloudsel[D:Auto Save]:%s\r"
  	"\ncloudsel[E:Auto Save Time]:%d minute(s)\r"
  	"\ncloudsel[F:Crash File Timeout]:%d day(s)\r"
  	"\ncloudsel[G:Rent File Timeout]:%d day(s)\r"
  	"\ncloud[done]:Q\r",
...
static void cedit_disp_room_numbers(struct descriptor_data *d)
{
  ...
  write_to_output(d, "\n\r"
    "\n## Room Numbers\r"
  	...
  	"\ncloudsel[C:Frozen Start Room]%d\r"
